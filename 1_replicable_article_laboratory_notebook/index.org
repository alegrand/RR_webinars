...
Download [[https://github.com/alegrand/RR_webinars/raw/master/1_replicable_article_laboratory_notebook/replicable/replicable.tgz][this archive]] and untar it:
#+begin_src sh :results output :exports both
tar zxf replicable.tgz;
cd replicable
make 
#+end_src
You should now be able to open the [[file:replicable/article.pdf][resulting article]].
