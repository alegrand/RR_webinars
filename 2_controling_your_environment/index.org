...
** Webcast/Video
Here is the *[[https://gricad.univ-grenoble-alpes.fr/video/controlling-your-environment][link to the video]]*. If you have any trouble with the
flashplayer, here is a *[[http://newstream.u-ga.fr/2016-04-05_Reproducible-Research_Diaz-Mercier.mp4][direct link to the mpeg4 video]]*. The *slides* are
available [[https://github.com/camilo1729/webinar-env/raw/master/ctl_environment.pdf][here]].

#+BEGIN_CENTER
[[https://gricad.univ-grenoble-alpes.fr/video/controlling-your-environment][file:video_thn.png]]
#+END_CENTER

To interact during the presentation (questions, comments), *we used
this [[https://pad.inria.fr/p/9mxzIpXQDgE1gyqD][pad]]* that we [[file:pad.org][keep for the record]].
** Persons in charge
