...
** Webcast/Video
Here are the links to the [[https://mi2s.imag.fr/controlling-your-environment-0][video]], to the [[https://pad.inria.fr/p/9mxzIpXQDgE1gyqD][pad]], and to the [[https://github.com/camilo1729/webinar-env/raw/master/ctl_environment.pdf][slides]].
** Persons in charge
