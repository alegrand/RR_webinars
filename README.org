...
#+BEGIN_CENTER
*Next event*: Tuesday 3 May, 1:30PM-4:30PM (UTC+2), 2016. [[file:3_numerical_reproducibility/index.org][Numerical
Reproducibility]] (The screencast is *[[https://mi2s.imag.fr/pm/direct][here]]* and some rooms where the
audience will gather are listed [[3_numerical_reproducibility/index.org#locations][here]]).
#+END_CENTER
