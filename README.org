...
#+BEGIN_CENTER
*Next event*: Monday 7 March,1:30PM-4:30PM (UTC+1), 2016. [[file:1_replicable_article_laboratory_notebook/index.org][Introduction (reproducible
research, challenges, ethic, ...). Producing replicable articles and
managing a laboratory notebook]] (The screencast is *[[https://mi2s.imag.fr/pm/direct][here]]* and some rooms where the audience will gather are listed [[1_replicable_article_laboratory_notebook/index.org#locations][here]]).
#+END_CENTER
